...
import { logout, checkAuthStatus, fetchUserData } from "Slices/AuthSlice";
import { fetchCredits } from "Slices/CreditSlice";
...
const TopBar = () => {
    ...
    // Credits state
    const { creditBalance, isLoading: isCreditsLoading } = useSelector((state: RootState) => state.credits);
                    ...
                    <Col lg={12}>
                        <div className="header-inner-one">
                            ...
                            <div className="header-right">
                                {/* Dark/Light toggle is now outside of auth conditional */}
                                ...
                                {!isAuthenticated ? (
                                    <div className="auth-buttons">
                                        <Link to="/login" className="rts-btn btn-secondary">
                                            Login
                                        </Link>
                                    ...
                                    <>
                                        {/* Credits display */}
                                        <div className="single_action__haeader credits-display openuptip">
                                            <div className="credit-display">
                                                ...
                                                {isCreditsLoading ? (
                                                    ...
                                                    <span className="credit-value">{creditBalance}</span>
                                                )}
                                            </div>
                                        </div>
                                                ...
                                                <div style={{ display: isProfile ? "block" : "none" }} className="user_information_main_wrapper slide-down__click">
                                                    <div className="user_header">
                                                        ...
                                                        <div className="user_naim-information">
                                                            <h3 className="title">{user ? user.username : 'User'}</h3>
                                                            <span className="desig">{user ? user.email : 'Loading...'}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="popup-footer-btn">
                                                        <Link to="#" onClick={handleLogout} className="geex-content__header__popup__footer__link">Logout
