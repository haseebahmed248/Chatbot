...
const Login = () => {
        ...
        if (isAuthenticated && user) {
          ...
          // For regular users, check verification status
            ...
            if (user.is_verified) {
              ...
              // For unverified users, show verification message but don't redirect
    ...
    return (
        <>
            {isLoading && <Loading fullScreen text="Logging in..." />}
                                ...
                                <Col lg={12}>
                                    <div className="single-form-s-wrapper">
                                        ...
                                        <div className="body">
                                            ...
                                            {verificationMessage && <Alert variant="warning">{verificationMessage}</Alert>}
