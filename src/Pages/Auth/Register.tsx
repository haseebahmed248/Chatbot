...
const Register = () => {
    ...
    // Redirect if already authenticated - but check verification status first
    useEffect(() => {
        if (isAuthenticated && user) {
            ...
            if (user.is_verified) {
                ...
                // For unverified users, show message but don't redirect
                setSuccessMessage("Your account has been created! Please wait for admin approval before accessing all features.");
            }
        }
    ...
    return (
        <>
            {isLoading && <Loading fullScreen text="Creating your account..." />}
                                            ...
                                            {!successMessage && (
                                                <form onSubmit={handleSubmit}>
                                                    ...
                                                    <div className="check-wrapper">
                                                        ...
                                                        {formErrors.agreeToTerms && <div className="error">{formErrors.agreeToTerms}</div>}
                                                    </div>
